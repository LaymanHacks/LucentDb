...
namespace LucentDb.Data.WebApiRepository
{
    ...
    public class WebApiRunHistoryRepository : IRunHistoryRepository, IDisposable
    {
        ...
        public void Update(Int32?  testId, Int32?  projectId, Int32?  testGroupId, DateTime runDateTime, Boolean isValid, string runLog, Int64 id)
        {
            using (var client = new HttpClient(_messageHandler))
            {
                client.BaseAddress = new Uri(_baseAddress);
        ...
        {
            Update(runHistory.TestId, runHistory.ProjectId, runHistory.GroupId, (DateTime)runHistory.RunDateTime, (bool)runHistory.IsValid, runHistory.RunLog, runHistory.Id);
        }
        ...
        public Int64 Insert(Int32?  testId, Int32?  projectId, Int32?  testGroupId, DateTime runDateTime, Boolean isValid, string runLog)
        {
            using (var client = new HttpClient(_messageHandler))
            {
                client.BaseAddress = new Uri(_baseAddress);
        ...
        {
            return Insert(runHistory.TestId, runHistory.ProjectId, runHistory.GroupId, (DateTime)runHistory.RunDateTime, (bool)runHistory.IsValid, runHistory.RunLog);
        }
