...
namespace LucentDb.Data.WebApiRepository
{
    ...
    public class WebApiTestRepository : ITestRepository, IDisposable
    {
        ...
        public void Update(Int32 testTypeId, Int32 testValueTypeId, Int32 projectId, Int32?  groupId, string name, string testValue, Boolean isActive, Int32 id)
        {
            using (var client = new HttpClient(_messageHandler))
            {
                client.BaseAddress = new Uri(_baseAddress);
                client.DefaultRequestHeaders.Accept.Clear();
                client.DefaultRequestHeaders.Accept.Add(new MediaTypeWithQualityHeaderValue("application/json"));
                var test = new Test(id, testTypeId, testValueTypeId, projectId, groupId, name, testValue, isActive);
        ...
        {
            Update((Int32)test.TestTypeId, (Int32)test.TestValueTypeId, (Int32)test.ProjectId, test.GroupId, test.Name, test.TestValue, (bool)test.IsActive, (Int32)test.Id);
        }
        ...
        public Int32 Insert(Int32 testTypeId, Int32 testValueTypeId, Int32 projectId, Int32?  groupId, string name, string testValue, Boolean isActive)
        {
            using (var client = new HttpClient(_messageHandler))
            {
                client.BaseAddress = new Uri(_baseAddress);
        ...
        {
            return Insert((Int32)test.TestTypeId, (Int32)test.TestValueTypeId, (Int32)test.ProjectId, test.GroupId, test.Name, test.TestValue, (bool)test.IsActive);
        }
        ...
        public ICollection<Test> GetDataByTestValueTypeId(Int32 testValueTypeId)
        {
            using (var client = new HttpClient(_messageHandler))
            {
                client.BaseAddress = new Uri(_baseAddress);
                client.DefaultRequestHeaders.Accept.Clear();
                client.DefaultRequestHeaders.Accept.Add(new MediaTypeWithQualityHeaderValue("application/json"));
                var response = client.GetAsync("/api/testValueTypes/" + testValueTypeId  + "/tests/all").Result;
                if (!response.IsSuccessStatusCode) return null;
                var resultString = response.Content.ReadAsStringAsync().Result;
                var returnValue = JsonConvert.DeserializeObject<ICollection<Test>>(resultString);
                return returnValue;
        ...
        public PagedResult<Test> GetDataByTestValueTypeIdPageable(Int32 testValueTypeId, string sortExpression, Int32 page, Int32 pageSize)
        {
            using (var client = new HttpClient(_messageHandler))
            {
                client.BaseAddress = new Uri(_baseAddress);
                client.DefaultRequestHeaders.Accept.Clear();
                client.DefaultRequestHeaders.Accept.Add(new MediaTypeWithQualityHeaderValue("application/json"));
                var response = client.GetAsync("/api/testValueTypes/" + testValueTypeId  + "/tests" + "?testValueTypeId=" + testValueTypeId + "&sortExpression=" + sortExpression + "&page=" + page + "&pageSize=" + pageSize).Result;
                if (!response.IsSuccessStatusCode) return null;
                var resultString = response.Content.ReadAsStringAsync().Result;
                var returnValue = JsonConvert.DeserializeObject<PagedResult<Test>>(resultString);
                return returnValue;
        ...
        public ICollection<Test> GetActiveDataByTestValueTypeId(Int32 testValueTypeId)
        {
            using (var client = new HttpClient(_messageHandler))
            {
                client.BaseAddress = new Uri(_baseAddress);
                client.DefaultRequestHeaders.Accept.Clear();
                client.DefaultRequestHeaders.Accept.Add(new MediaTypeWithQualityHeaderValue("application/json"));
                var response = client.GetAsync("/api/testValueTypes/" + testValueTypeId  + "/tests/all/active").Result;
                if (!response.IsSuccessStatusCode) return null;
                var resultString = response.Content.ReadAsStringAsync().Result;
                var returnValue = JsonConvert.DeserializeObject<ICollection<Test>>(resultString);
                return returnValue;
        ...
        public PagedResult<Test> GetActiveDataByTestValueTypeIdPageable(Int32 testValueTypeId, string sortExpression, Int32 page, Int32 pageSize)
        {
            using (var client = new HttpClient(_messageHandler))
            {
                client.BaseAddress = new Uri(_baseAddress);
                client.DefaultRequestHeaders.Accept.Clear();
                client.DefaultRequestHeaders.Accept.Add(new MediaTypeWithQualityHeaderValue("application/json"));
                var response = client.GetAsync("/api/testValueTypes/" + testValueTypeId  + "/tests/active" + "?testValueTypeId=" + testValueTypeId + "&sortExpression=" + sortExpression + "&page=" + page + "&pageSize=" + pageSize).Result;
                if (!response.IsSuccessStatusCode) return null;
                var resultString = response.Content.ReadAsStringAsync().Result;
                var returnValue = JsonConvert.DeserializeObject<PagedResult<Test>>(resultString);
                return returnValue;
