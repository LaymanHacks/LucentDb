...
namespace LucentDb.Data.WebApiRepository
{
    ...
    public class WebApiTestRepository : ITestRepository, IDisposable
    {
        ...
        public void Update(int testTypeId, int testValueTypeId, int projectId, int? groupId, string name,
            string testValue, bool isActive, int id)
        {
            using (var client = new HttpClient(_messageHandler))
            {
                client.BaseAddress = new Uri(_baseAddress);
        ...
        {
            Update(test.TestTypeId, test.TestValueTypeId, test.ProjectId, test.GroupId, test.Name, test.TestValue,
                test.IsActive, test.Id);
        }
        ...
        public int Insert(int testTypeId, int testValueTypeId, int projectId, int? groupId, string name,
        ...
        {
            return Insert(test.TestTypeId, test.TestValueTypeId, test.ProjectId, test.GroupId, test.Name, test.TestValue,
                test.IsActive);
        }
        ...
        public ICollection<Test> GetDataByTestValueTypeId(int testValueTypeId)
        {
            using (var client = new HttpClient(_messageHandler))
            {
                client.BaseAddress = new Uri(_baseAddress);
        ...
        public PagedResult<Test> GetDataByTestValueTypeIdPageable(int testValueTypeId, string sortExpression, int page,
            int pageSize)
        {
            using (var client = new HttpClient(_messageHandler))
            {
                ...
                client.DefaultRequestHeaders.Accept.Add(new MediaTypeWithQualityHeaderValue("application/json"));
                var response =
                    client.GetAsync("/api/testValueTypes/" + testValueTypeId + "/tests" + "?testValueTypeId=" +
                                    testValueTypeId + "&sortExpression=" + sortExpression + "&page=" + page +
                                    "&pageSize=" + pageSize).Result;
                if (!response.IsSuccessStatusCode) return null;
                var resultString = response.Content.ReadAsStringAsync().Result;
                var returnValue = JsonConvert.DeserializeObject<PagedResult<Test>>(resultString);
        ...
        public ICollection<Test> GetActiveDataByTestValueTypeId(int testValueTypeId)
        {
            using (var client = new HttpClient(_messageHandler))
            {
                client.BaseAddress = new Uri(_baseAddress);
        ...
        public PagedResult<Test> GetActiveDataByTestValueTypeIdPageable(int testValueTypeId, string sortExpression,
            int page, int pageSize)
        {
            using (var client = new HttpClient(_messageHandler))
            {
                ...
                client.DefaultRequestHeaders.Accept.Add(new MediaTypeWithQualityHeaderValue("application/json"));
                var response =
                    client.GetAsync("/api/testValueTypes/" + testValueTypeId + "/tests/active" + "?testValueTypeId=" +
                                    testValueTypeId + "&sortExpression=" + sortExpression + "&page=" + page +
                                    "&pageSize=" + pageSize).Result;
                if (!response.IsSuccessStatusCode) return null;
                var resultString = response.Content.ReadAsStringAsync().Result;
