...
Namespace LucentDb.Data.SqlDbCommandProvider
    Public Class SqlDbRunHistoryCommandProvider
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function GetUpdateDbCommand(testId As Int32, runDateTime As DateTime, isValid As Boolean,
                                           runLog As String, resultString As String, id As Int64) As IDbCommand _
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function GetInsertDbCommand(testId As Int32, runDateTime As DateTime, isValid As Boolean,
                                           runLog As String, resultString As String) As IDbCommand _
