...
Namespace LucentDb.Data.SqlDbCommandProvider
    Public Class SqlDbRunHistoryCommandProvider
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function GetUpdateDbCommand(scriptId As Int32, runDateTime As DateTime, isPass As Boolean,
                                           resultString As String, id As Int64) As IDbCommand _
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function GetInsertDbCommand(scriptId As Int32, runDateTime As DateTime, isPass As Boolean,
