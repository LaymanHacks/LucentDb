...
Namespace LucentDb.Data.SqlDbCommandProvider
    Public Class SqlDbRunHistoryCommandProvider
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function GetUpdateDbCommand(id As Int64, scriptId As Int32, runDateTime As DateTime, isPass As Boolean,
                                           resultString As String, original_Id As Int64) As IDbCommand _
            ...
            Else
                command.Parameters.Add(SqlParameterFactory.CreateInputParameter("@ResultString", SqlDbType.varchar,
                                                                                DBNull.Value))
            End If
            command.Parameters.Add(SqlParameterFactory.CreateInputParameter("@Original_Id", SqlDbType.bigint,
                                                                            original_Id))
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function GetInsertDbCommand(id As Int64, scriptId As Int32, runDateTime As DateTime, isPass As Boolean,
                                           resultString As String) As IDbCommand _
        ...
        Public Function GetGetDataByScriptIdDbCommand(scriptId As Int32) As IDbCommand _
            Implements IDbRunHistoryCommandProvider.GetGetDataByScriptIdDbCommand
        ...
        Public Function GetGetDataByScriptIdPageableDbCommand(scriptId As Int32, sortExpression As String, page As Int32,
            ...
            Implements IDbRunHistoryCommandProvider.GetGetDataByScriptIdPageableDbCommand
        ...
        Public Function GetGetDataByScriptIdRowCountDbCommand(scriptId As Int32) As IDbCommand _
            Implements IDbRunHistoryCommandProvider.GetGetDataByScriptIdRowCountDbCommand
