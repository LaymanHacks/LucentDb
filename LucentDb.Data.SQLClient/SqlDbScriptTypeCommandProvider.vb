...
Namespace LucentDb.Data.SqlDbCommandProvider
    Public Class SqlDbScriptTypeCommandProvider
        ...
        Public ReadOnly Property ScriptTypeDbConnectionHolder As DbConnectionHolder _
            Implements IDbScriptTypeCommandProvider.ScriptTypeDbConnectionHolder
            Get
        ...
        Public Function GetUpdateDbCommand(name As String, isActive As Boolean, id As Int32) As IDbCommand _
            Implements IDbScriptTypeCommandProvider.GetUpdateDbCommand
        ...
        Public Function GetDeleteDbCommand(id As Int32) As IDbCommand _
            Implements IDbScriptTypeCommandProvider.GetDeleteDbCommand
        ...
        Public Function GetInsertDbCommand(name As String, isActive As Boolean) As IDbCommand _
            Implements IDbScriptTypeCommandProvider.GetInsertDbCommand
        ...
        Public Function GetGetDataPageableDbCommand(sortExpression As String, page As Int32, pageSize As Int32) _
            As IDbCommand Implements IDbScriptTypeCommandProvider.GetGetDataPageableDbCommand
        ...
        Public Function GetGetRowCountDbCommand() As IDbCommand _
            Implements IDbScriptTypeCommandProvider.GetGetRowCountDbCommand
        ...
        Public Function GetGetDataByIdDbCommand(id As Int32) As IDbCommand _
            Implements IDbScriptTypeCommandProvider.GetGetDataByIdDbCommand
        ...
        Public Function GetGetActiveDataDbCommand() As IDbCommand _
            Implements IDbScriptTypeCommandProvider.GetGetActiveDataDbCommand
        ...
        Public Function GetGetActiveDataPageableDbCommand(sortExpression As String, page As Int32, pageSize As Int32) _
            As IDbCommand Implements IDbScriptTypeCommandProvider.GetGetActiveDataPageableDbCommand
        ...
        Public Function GetGetActiveDataRowCountDbCommand() As IDbCommand _
            Implements IDbScriptTypeCommandProvider.GetGetActiveDataRowCountDbCommand
