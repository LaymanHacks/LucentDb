...
Public Class SqlDbTestCommandProvider
      ...
      ''' <param name="id" />
        ''' <returns></returns>
        ''' <remarks></remarks> 
        Public Function GetUpdateDbCommand( ByVal testTypeId As Int32,  ByVal testValueTypeId As Int32,  ByVal projectId As Int32,  ByVal groupId As  Nullable(Of Int32) ,  ByVal name As String,  ByVal testValue As String,  ByVal isActive As Boolean,  ByVal id As Int32) As IDbCommand Implements IDbTestCommandProvider.GetUpdateDbCommand
            ...
            command.CommandType = CommandType.StoredProcedure
                command.Parameters.Add(SqlParameterFactory.CreateInputParameter("@TestTypeId", SqlDbType.int, testTypeId))
                  command.Parameters.Add(SqlParameterFactory.CreateInputParameter("@TestValueTypeId", SqlDbType.int, testValueTypeId))
      ...
      ''' <param name="isActive" />
        ''' <returns></returns>
        ''' <remarks></remarks> 
        Public Function GetInsertDbCommand( ByVal testTypeId As Int32,  ByVal testValueTypeId As Int32,  ByVal projectId As Int32,  ByVal groupId As  Nullable(Of Int32) ,  ByVal name As String,  ByVal testValue As String,  ByVal isActive As Boolean) As IDbCommand Implements IDbTestCommandProvider.GetInsertDbCommand
      ...
      ''' <param name="testValueTypeId" />
        ''' <returns></returns>
        ''' <remarks></remarks> 
        Public Function GetGetDataByTestValueTypeIdDbCommand( ByVal testValueTypeId As Int32) As IDbCommand Implements IDbTestCommandProvider.GetGetDataByTestValueTypeIdDbCommand
      ...
      ''' <param name="pageSize" />
        ''' <returns></returns>
        ''' <remarks></remarks> 
        Public Function GetGetDataByTestValueTypeIdPageableDbCommand( ByVal testValueTypeId As Int32,  ByVal sortExpression As String,  ByVal page As Int32,  ByVal pageSize As Int32) As IDbCommand Implements IDbTestCommandProvider.GetGetDataByTestValueTypeIdPageableDbCommand
      ...
      ''' <param name="testValueTypeId" />
        ''' <returns></returns>
        ''' <remarks></remarks> 
        Public Function GetGetDataByTestValueTypeIdRowCountDbCommand( ByVal testValueTypeId As Int32) As IDbCommand Implements IDbTestCommandProvider.GetGetDataByTestValueTypeIdRowCountDbCommand
      ...
      ''' <param name="testValueTypeId" />
        ''' <returns></returns>
        ''' <remarks></remarks> 
        Public Function GetGetActiveDataByTestValueTypeIdDbCommand( ByVal testValueTypeId As Int32) As IDbCommand Implements IDbTestCommandProvider.GetGetActiveDataByTestValueTypeIdDbCommand
      ...
      ''' <param name="pageSize" />
        ''' <returns></returns>
        ''' <remarks></remarks> 
        Public Function GetGetActiveDataByTestValueTypeIdPageableDbCommand( ByVal testValueTypeId As Int32,  ByVal sortExpression As String,  ByVal page As Int32,  ByVal pageSize As Int32) As IDbCommand Implements IDbTestCommandProvider.GetGetActiveDataByTestValueTypeIdPageableDbCommand
      ...
      ''' <param name="testValueTypeId" />
        ''' <returns></returns>
        ''' <remarks></remarks> 
        Public Function GetGetActiveDataByTestValueTypeIdRowCountDbCommand( ByVal testValueTypeId As Int32) As IDbCommand Implements IDbTestCommandProvider.GetGetActiveDataByTestValueTypeIdRowCountDbCommand
