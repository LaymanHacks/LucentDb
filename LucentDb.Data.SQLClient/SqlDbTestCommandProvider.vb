...
Public Class SqlDbTestCommandProvider
      ...
      ''' <param name="id" />
        ''' <returns></returns>
        ''' <remarks></remarks> 
        Public Function GetUpdateDbCommand( ByVal projectId As Int32,  ByVal testTypeId As Int32,  ByVal name As String,  ByVal isActive As Boolean,  ByVal id As Int32) As IDbCommand Implements IDbTestCommandProvider.GetUpdateDbCommand
      ...
      ''' <param name="isActive" />
        ''' <returns></returns>
        ''' <remarks></remarks> 
        Public Function GetInsertDbCommand( ByVal projectId As Int32,  ByVal testTypeId As Int32,  ByVal name As String,  ByVal isActive As Boolean) As IDbCommand Implements IDbTestCommandProvider.GetInsertDbCommand
      ...
      End Function
        ...
        ''' <summary>
        ''' Function GetTestsForScriptByScriptId returns a IDataReader for Test
        ''' </summary>
      ''' <param name="scriptId" />
        ''' <returns></returns>
        ''' <remarks></remarks> 
        Public Function GetGetTestsForScriptByScriptIdDbCommand( ByVal scriptId As Int32) As IDbCommand Implements IDbTestCommandProvider.GetGetTestsForScriptByScriptIdDbCommand
            
            Dim command As New SqlCommand("Test_GetTestsForScriptByScriptId")
            command.CommandType = CommandType.StoredProcedure
