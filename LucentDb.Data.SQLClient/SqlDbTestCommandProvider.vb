...
Namespace LucentDb.Data.SqlDbCommandProvider
    Public Class SqlDbTestCommandProvider
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function GetUpdateDbCommand(projectId As Int32, testTypeId As Int32, name As String, isActive As Boolean,
                                           id As Int32) As IDbCommand _
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function GetInsertDbCommand(projectId As Int32, testTypeId As Int32, name As String, isActive As Boolean) _
            As IDbCommand Implements IDbTestCommandProvider.GetInsertDbCommand
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function GetGetTestsForScriptByScriptIdDbCommand(scriptId As Int32) As IDbCommand _
            Implements IDbTestCommandProvider.GetGetTestsForScriptByScriptIdDbCommand
