...
Namespace LucentDb.Data.SqlDbCommandProvider
    Public Class SqlDbScriptCommandProvider
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function GetUpdateDbCommand(testId As Int32, scriptTypeId As Int32, name As String, scriptValue As String,
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function GetInsertDbCommand(testId As Int32, scriptTypeId As Int32, name As String, scriptValue As String,
