...
Namespace LucentDb.Data.SqlDbCommandProvider
    Public Class SqlDbTest_ScriptCommandProvider
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function GetGetDataByTestIdScriptIdDbCommand(testId As Int32, scriptId As Int32) As IDbCommand _
            Implements IDbTest_ScriptCommandProvider.GetGetDataByTestIdScriptIdDbCommand
