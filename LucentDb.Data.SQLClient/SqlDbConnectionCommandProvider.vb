...
Namespace LucentDb.Data.SqlDbCommandProvider
    Public Class SqlDbConnectionCommandProvider
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function GetUpdateDbCommand(connectionProviderId As Nullable(Of Int32), name As String,
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function GetInsertDbCommand(connectionProviderId As Nullable(Of Int32), name As String,
                                           connectionString As String, isActive As Boolean) As IDbCommand _
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function GetGetConnectionsForProjectByProjectIdDbCommand(projectId As Int32) As IDbCommand _
            Implements IDbConnectionCommandProvider.GetGetConnectionsForProjectByProjectIdDbCommand
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function GetGetConnectionsForProjectByProjectIdPageableDbCommand(projectId As Int32,
                                                                                sortExpression As String, page As Int32,
                                                                                pageSize As Int32) As IDbCommand _
            Implements IDbConnectionCommandProvider.GetGetConnectionsForProjectByProjectIdPageableDbCommand
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function GetGetConnectionsForProjectByProjectIdRowCountDbCommand(projectId As Int32) As IDbCommand _
            Implements IDbConnectionCommandProvider.GetGetConnectionsForProjectByProjectIdRowCountDbCommand
