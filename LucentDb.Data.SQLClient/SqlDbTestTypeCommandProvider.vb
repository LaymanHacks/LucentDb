...
Public Class SqlDbTestTypeCommandProvider
      ...
      ''' <param name="id" />
        ''' <returns></returns>
        ''' <remarks></remarks> 
        Public Function GetUpdateDbCommand( ByVal name As String,  ByVal testValidatorType As String,  ByVal isActive As Boolean,  ByVal id As Int32) As IDbCommand Implements IDbTestTypeCommandProvider.GetUpdateDbCommand
      ...
      End If
            ...
            If (Not testValidatorType  Is Nothing ) Then
                            command.Parameters.Add(SqlParameterFactory.CreateInputParameter("@TestValidatorType", SqlDbType.varchar, testValidatorType))
      Else
                            command.Parameters.Add(SqlParameterFactory.CreateInputParameter("@TestValidatorType", SqlDbType.varchar, global.System.DBNull.Value))
      End If
      ...
      ''' <param name="isActive" />
        ''' <returns></returns>
        ''' <remarks></remarks> 
        Public Function GetInsertDbCommand( ByVal name As String,  ByVal testValidatorType As String,  ByVal isActive As Boolean) As IDbCommand Implements IDbTestTypeCommandProvider.GetInsertDbCommand
