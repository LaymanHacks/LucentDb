...
Namespace LucentDb.Data.SqlDbCommandProvider
    Public Class SqlDbTestTypeCommandProvider
        ...
        ''' </summary>
        ''' <param name="name" />
        ''' <param name="testValidatorType" />
        ''' <param name="isActive" />
        ''' <param name="id" />
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function GetUpdateDbCommand(name As String, testValidatorType As String, isActive As Boolean, id As Int32) _
            As IDbCommand Implements IDbTestTypeCommandProvider.GetUpdateDbCommand
            ...
            If (Not testValidatorType Is Nothing) Then
                command.Parameters.Add(SqlParameterFactory.CreateInputParameter("@TestValidatorType", SqlDbType.varchar,
                                                                                testValidatorType))
            Else
                command.Parameters.Add(SqlParameterFactory.CreateInputParameter("@TestValidatorType", SqlDbType.varchar,
                                                                                DBNull.Value))
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function GetInsertDbCommand(name As String, testValidatorType As String, isActive As Boolean) _
            As IDbCommand Implements IDbTestTypeCommandProvider.GetInsertDbCommand
