...
Namespace LucentDb.Data.SqlDbCommandProvider
    Public Class SqlDbRunHistoryDetailCommandProvider
        ...
        Public ReadOnly Property DbConnectionName As String _
            Implements IDbRunHistoryDetailCommandProvider.DbConnectionName
            Get
                Return "LucentDbConnection"
            End Get
        End Property

        Public ReadOnly Property RunHistoryDetailDbConnectionHolder As DbConnectionHolder _
            Implements IDbRunHistoryDetailCommandProvider.RunHistoryDetailDbConnectionHolder
            Get
        ...
        Public Function GetGetDataDbCommand() As IDbCommand _
            Implements IDbRunHistoryDetailCommandProvider.GetGetDataDbCommand
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function GetUpdateDbCommand(runHistoryId As Int64, testId As Int32, runDateTime As DateTime,
                                           duration As Nullable(Of Decimal), isValid As Boolean, resultString As String,
                                           id As Int64) As IDbCommand _
            Implements IDbRunHistoryDetailCommandProvider.GetUpdateDbCommand

            Dim command As New SqlCommand("RunHistoryDetail_Update")
            command.CommandType = CommandType.StoredProcedure
            command.Parameters.Add(SqlParameterFactory.CreateInputParameter("@RunHistoryId", SqlDbType.bigint,
                                                                            runHistoryId))
            ...
            If (Duration.HasValue = true) Then
                command.Parameters.Add(SqlParameterFactory.CreateInputParameter("@Duration", SqlDbType.decimal, duration))
            Else
                command.Parameters.Add(SqlParameterFactory.CreateInputParameter("@Duration", SqlDbType.decimal,
                                                                                DBNull.Value))
            End If
            ...
            If (Not resultString Is Nothing) Then
                command.Parameters.Add(SqlParameterFactory.CreateInputParameter("@ResultString", SqlDbType.varchar,
                                                                                resultString))
            Else
                command.Parameters.Add(SqlParameterFactory.CreateInputParameter("@ResultString", SqlDbType.varchar,
                                                                                DBNull.Value))
        ...
        Public Function GetDeleteDbCommand(id As Int64) As IDbCommand _
            Implements IDbRunHistoryDetailCommandProvider.GetDeleteDbCommand
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function GetInsertDbCommand(runHistoryId As Int64, testId As Int32, runDateTime As DateTime,
                                           duration As Nullable(Of Decimal), isValid As Boolean, resultString As String) _
            As IDbCommand Implements IDbRunHistoryDetailCommandProvider.GetInsertDbCommand
        ...
        Public Function GetGetDataPageableDbCommand(sortExpression As String, page As Int32, pageSize As Int32) _
            As IDbCommand Implements IDbRunHistoryDetailCommandProvider.GetGetDataPageableDbCommand
        ...
        Public Function GetGetRowCountDbCommand() As IDbCommand _
            Implements IDbRunHistoryDetailCommandProvider.GetGetRowCountDbCommand
        ...
        Public Function GetGetDataByIdDbCommand(id As Int64) As IDbCommand _
            Implements IDbRunHistoryDetailCommandProvider.GetGetDataByIdDbCommand
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function GetGetDataByRunHistoryIdDbCommand(runHistoryId As Int64) As IDbCommand _
            Implements IDbRunHistoryDetailCommandProvider.GetGetDataByRunHistoryIdDbCommand
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function GetGetDataByRunHistoryIdPageableDbCommand(runHistoryId As Int64, sortExpression As String,
                                                                  page As Int32, pageSize As Int32) As IDbCommand _
            Implements IDbRunHistoryDetailCommandProvider.GetGetDataByRunHistoryIdPageableDbCommand
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function GetGetDataByRunHistoryIdRowCountDbCommand(runHistoryId As Int64) As IDbCommand _
            Implements IDbRunHistoryDetailCommandProvider.GetGetDataByRunHistoryIdRowCountDbCommand
