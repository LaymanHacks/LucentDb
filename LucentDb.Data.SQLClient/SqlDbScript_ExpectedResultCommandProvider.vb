...
Namespace LucentDb.Data.SqlDbCommandProvider
    Public Class SqlDbScript_ExpectedResultCommandProvider
        ...
        ''' <param name="original_ResultIndex" />
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function GetUpdateDbCommand(scriptId As Int32, expectedResultId As Int32, resultIndex As Int32,
                                           ...
                                           original_ResultIndex As Int32) As IDbCommand _
            ...
            command.Parameters.Add(SqlParameterFactory.CreateInputParameter("@Original_ResultIndex", SqlDbType.int,
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function GetDeleteDbCommand(scriptId As Int32, expectedResultId As Int32, resultIndex As Int32) _
            As IDbCommand Implements IDbScript_ExpectedResultCommandProvider.GetDeleteDbCommand
