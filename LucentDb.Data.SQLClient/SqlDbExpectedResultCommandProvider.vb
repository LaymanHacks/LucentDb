...
Namespace LucentDb.Data.SqlDbCommandProvider
    Public Class SqlDbExpectedResultCommandProvider
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function GetUpdateDbCommand(expectedValue As String, assertTypeId As Nullable(Of Int32), id As Int32) _
            As IDbCommand Implements IDbExpectedResultCommandProvider.GetUpdateDbCommand
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function GetInsertDbCommand(expectedValue As String, assertTypeId As Nullable(Of Int32)) As IDbCommand _
