...
Namespace LucentDb.Data.SqlDbCommandProvider
    Public Class SqlDbProject_ConnectionCommandProvider
        ...
        Public ReadOnly Property DbConnectionName As String _
            Implements IDbProject_ConnectionCommandProvider.DbConnectionName
            Get
                Return "LucentDbConnection"
            End Get
        End Property

        Public ReadOnly Property Project_ConnectionDbConnectionHolder As DbConnectionHolder _
            Implements IDbProject_ConnectionCommandProvider.Project_ConnectionDbConnectionHolder
            Get
        ...
        Public Function GetGetDataDbCommand() As IDbCommand _
            Implements IDbProject_ConnectionCommandProvider.GetGetDataDbCommand
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function GetUpdateDbCommand(projectId As Int32, connectionId As Int32, original_ProjectId As Int32,
                                           original_ConnectionId As Int32) As IDbCommand _
            Implements IDbProject_ConnectionCommandProvider.GetUpdateDbCommand
            ...
            command.Parameters.Add(SqlParameterFactory.CreateInputParameter("@Original_ProjectId", SqlDbType.int,
                                                                            original_ProjectId))
            command.Parameters.Add(SqlParameterFactory.CreateInputParameter("@Original_ConnectionId", SqlDbType.int,
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function GetDeleteDbCommand(projectId As Int32, connectionId As Int32) As IDbCommand _
            Implements IDbProject_ConnectionCommandProvider.GetDeleteDbCommand
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function GetInsertDbCommand(projectId As Int32, connectionId As Int32) As IDbCommand _
            Implements IDbProject_ConnectionCommandProvider.GetInsertDbCommand
        ...
        Public Function GetGetDataPageableDbCommand(sortExpression As String, page As Int32, pageSize As Int32) _
            As IDbCommand Implements IDbProject_ConnectionCommandProvider.GetGetDataPageableDbCommand
        ...
        Public Function GetGetRowCountDbCommand() As IDbCommand _
            Implements IDbProject_ConnectionCommandProvider.GetGetRowCountDbCommand
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function GetGetDataByProjectIdConnectionIdDbCommand(projectId As Int32, connectionId As Int32) _
            As IDbCommand Implements IDbProject_ConnectionCommandProvider.GetGetDataByProjectIdConnectionIdDbCommand
        ...
        Public Function GetGetDataByConnectionIdDbCommand(connectionId As Int32) As IDbCommand _
            Implements IDbProject_ConnectionCommandProvider.GetGetDataByConnectionIdDbCommand
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function GetGetDataByConnectionIdPageableDbCommand(connectionId As Int32, sortExpression As String,
                                                                  page As Int32, pageSize As Int32) As IDbCommand _
            Implements IDbProject_ConnectionCommandProvider.GetGetDataByConnectionIdPageableDbCommand
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function GetGetDataByConnectionIdRowCountDbCommand(connectionId As Int32) As IDbCommand _
            Implements IDbProject_ConnectionCommandProvider.GetGetDataByConnectionIdRowCountDbCommand
        ...
        Public Function GetGetDataByProjectIdDbCommand(projectId As Int32) As IDbCommand _
            Implements IDbProject_ConnectionCommandProvider.GetGetDataByProjectIdDbCommand
        ...
        Public Function GetGetDataByProjectIdPageableDbCommand(projectId As Int32, sortExpression As String,
                                                               page As Int32, pageSize As Int32) As IDbCommand _
            Implements IDbProject_ConnectionCommandProvider.GetGetDataByProjectIdPageableDbCommand
        ...
        Public Function GetGetDataByProjectIdRowCountDbCommand(projectId As Int32) As IDbCommand _
            Implements IDbProject_ConnectionCommandProvider.GetGetDataByProjectIdRowCountDbCommand
