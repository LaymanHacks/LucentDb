...
Namespace LucentDb.Data.SqlDbCommandProvider
    Public Class SqlDbProjectCommandProvider
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function GetGetProjectsForConnectionByConnectionIdDbCommand(connectionId As Int32) As IDbCommand _
            Implements IDbProjectCommandProvider.GetGetProjectsForConnectionByConnectionIdDbCommand
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function GetGetProjectsForConnectionByConnectionIdPageableDbCommand(connectionId As Int32,
                                                                                   sortExpression As String,
                                                                                   page As Int32, pageSize As Int32) _
            As IDbCommand _
            Implements IDbProjectCommandProvider.GetGetProjectsForConnectionByConnectionIdPageableDbCommand
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function GetGetProjectsForConnectionByConnectionIdRowCountDbCommand(connectionId As Int32) As IDbCommand _
            Implements IDbProjectCommandProvider.GetGetProjectsForConnectionByConnectionIdRowCountDbCommand
