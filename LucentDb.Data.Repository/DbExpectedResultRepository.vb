...
Namespace LucentDb.Data.Repository    
    ...
    Public Function GetData()  as ICollection(Of ExpectedResult) Implements IExpectedResultRepository.GetData
        Dim command As IDbCommand = _dbExpectedResultCommandProvider.GetGetDataDbCommand()
            ...
            Do While (reader.Read())
                 Dim tempEntity As New ExpectedResult( reader.GetInt32("Id"),  reader.GetInt32("TestId"),  reader.GetString("ExpectedValue") ,  reader.GetNullableInt32("AssertTypeId"),  reader.GetInt32("ResultIndex"))
  ...
  <Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)> _ 
    Public Sub Update( ByVal testId As Int32,  ByVal expectedValue As String,  ByVal assertTypeId As  Nullable(Of Int32) ,  ByVal resultIndex As Int32,  ByVal id As Int32)  Implements IExpectedResultRepository.Update
        Dim command As IDbCommand = _dbExpectedResultCommandProvider.GetUpdateDbCommand(TestId, ExpectedValue, AssertTypeId, ResultIndex, Id)
            command.Connection = _dbConnHolder.Connection
            _dbConnHolder.Open()
...
Delete( CInt(.Id))
  ...
  <Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Insert, true)> _ 
    Public Function Insert( ByVal testId As Int32,  ByVal expectedValue As String,  ByVal assertTypeId As  Nullable(Of Int32) ,  ByVal resultIndex As Int32)  as Int32 Implements IExpectedResultRepository.Insert
        Dim command As IDbCommand = _dbExpectedResultCommandProvider.GetInsertDbCommand(TestId, ExpectedValue, AssertTypeId, ResultIndex)
            command.Connection = _dbConnHolder.Connection
            _dbConnHolder.Open()
