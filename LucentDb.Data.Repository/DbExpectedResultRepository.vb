    ...
    Public Class DbExpectedResultRepository
        ...
        Public Function GetData() as ICollection(Of ExpectedResult) Implements IExpectedResultRepository.GetData
            ...
            Do While (reader.Read())
                Dim _
                    tempEntity As _
                        New ExpectedResult(reader.GetInt32("Id"), reader.GetString("ExpectedValue"),
                                           reader.GetNullableInt32("AssertTypeId"))
        ...
        Public Sub Update(expectedValue As String, assertTypeId As Nullable(Of Int32), id As Int32) _
            Implements IExpectedResultRepository.Update
            Dim command As IDbCommand = _dbExpectedResultCommandProvider.GetUpdateDbCommand(ExpectedValue, AssertTypeId,
                                                                                            Id)
            command.Connection = _dbConnHolder.Connection
            _dbConnHolder.Open()
        ...
        Public Function Insert(expectedValue As String, assertTypeId As Nullable(Of Int32)) as Int32 _
            Implements IExpectedResultRepository.Insert
