    ...
    Public Class DbScriptRepository
        ...
        Public Function GetData() As ICollection(Of Script) Implements IScriptRepository.GetData
            ...
            Do While (reader.Read())
                Dim _
                    tempEntity As _
                        New Script(reader.GetInt32("Id"), reader.GetInt32("TestId"), reader.GetInt32("ScriptTypeId"),
                                   reader.GetString("Name"), reader.GetString("ScriptValue"),
        ...
        Public Sub Update(testId As Int32, scriptTypeId As Int32, name As String, scriptValue As String,
                          isActive As Boolean, id As Int32) Implements IScriptRepository.Update
            Dim command As IDbCommand = _dbScriptCommandProvider.GetUpdateDbCommand(TestId, ScriptTypeId, Name,
                                                                                    ScriptValue, IsActive, Id)
            command.Connection = _dbConnHolder.Connection
            _dbConnHolder.Open()
        ...
        Public Sub Update(script As Script) Implements IScriptRepository.Update
            With Script
                Update(CInt(.TestId), CInt(.ScriptTypeId), .Name, .ScriptValue, CBool(.IsActive), CInt(.Id))
            End With
        End Sub
        ...
        Public Function Insert(testId As Int32, scriptTypeId As Int32, name As String, scriptValue As String,
                               isActive As Boolean) As Int32 Implements IScriptRepository.Insert
            Dim command As IDbCommand = _dbScriptCommandProvider.GetInsertDbCommand(TestId, ScriptTypeId, Name,
                                                                                    ScriptValue, IsActive)
            command.Connection = _dbConnHolder.Connection
            _dbConnHolder.Open()
        ...
        Public Function Insert(script As Script) As Int32 Implements IScriptRepository.Insert
            With Script
                Return Insert(CInt(.TestId), CInt(.ScriptTypeId), .Name, .ScriptValue, CBool(.IsActive))
            End With
        End Function
