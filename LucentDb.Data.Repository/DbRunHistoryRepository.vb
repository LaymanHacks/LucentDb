...
Namespace LucentDb.Data.Repository
    ...
    Public Class DbRunHistoryRepository
                ...
                Dim _
                    tempEntity As _
                        New RunHistory(reader.GetInt64("Id"), reader.GetNullableInt32("TestId"),
                                       reader.GetNullableInt32("ProjectId"), reader.GetNullableInt32("TestGroupId"),
                                       reader.GetDateTime("RunDateTime"), reader.GetBoolean("IsValid"),
        ...
        Public Sub Update(testId As Nullable(Of Int32), projectId As Nullable(Of Int32),
                          testGroupId As Nullable(Of Int32), runDateTime As DateTime, isValid As Boolean,
                          runLog As String, id As Int64) Implements IRunHistoryRepository.Update
            Dim command As IDbCommand = _dbRunHistoryCommandProvider.GetUpdateDbCommand(TestId, ProjectId, TestGroupId,
                                                                                        RunDateTime, IsValid, RunLog, Id)
            command.Connection = _dbConnHolder.Connection
            _dbConnHolder.Open()
        ...
        Public Sub Update(runHistory As RunHistory) Implements IRunHistoryRepository.Update
            With RunHistory
                Update(.TestId, .ProjectId, .GroupId, CDate(.RunDateTime), CBool(.IsValid), .RunLog, CLng(.Id))
            End With
        End Sub
        ...
        Public Function Insert(testId As Nullable(Of Int32), projectId As Nullable(Of Int32),
            ...
            Dim command As IDbCommand = _dbRunHistoryCommandProvider.GetInsertDbCommand(TestId, ProjectId, TestGroupId,
                                                                                        RunDateTime, IsValid, RunLog)
            command.Connection = _dbConnHolder.Connection
            _dbConnHolder.Open()
        ...
        Public Function Insert(runHistory As RunHistory) As Int64 Implements IRunHistoryRepository.Insert
            With RunHistory
                Return Insert(.TestId, .ProjectId, .GroupId, CDate(.RunDateTime), CBool(.IsValid), .RunLog)
            End With
        End Function
