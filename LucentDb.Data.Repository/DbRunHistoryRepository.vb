...
Namespace LucentDb.Data.Repository
    ...
    Public Class DbRunHistoryRepository
        ...
        Public Sub Update(testId As Int32, runDateTime As DateTime, isValid As Boolean, runLog As String,
                          resultString As String, id As Int64) Implements IRunHistoryRepository.Update
            Dim command As IDbCommand = _dbRunHistoryCommandProvider.GetUpdateDbCommand(TestId, RunDateTime, IsValid,
        ...
        Public Function Insert(testId As Int32, runDateTime As DateTime, isValid As Boolean, runLog As String,
                               resultString As String) As Int64 Implements IRunHistoryRepository.Insert
            Dim command As IDbCommand = _dbRunHistoryCommandProvider.GetInsertDbCommand(TestId, RunDateTime, IsValid,
                                                                                        RunLog, ResultString)
            command.Connection = _dbConnHolder.Connection
            _dbConnHolder.Open()
