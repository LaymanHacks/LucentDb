...
Namespace LucentDb.Data.Repository    
    ...
    Public Class DbRunHistoryRepository
        ...
        End Sub
            ...
            Do While (reader.Read())
                 Dim tempEntity As New RunHistory( reader.GetInt64("Id"),  reader.GetNullableInt32("TestId"),  reader.GetNullableInt32("ProjectId"),  reader.GetNullableInt32("TestGroupId"),  reader.GetDateTime("RunDateTime"),  reader.GetBoolean("IsValid"),  reader.GetString("RunLog") )
    ...
    End Function
          Public Sub Update( ByVal testId As  Nullable(Of Int32) ,  ByVal projectId As  Nullable(Of Int32) ,  ByVal testGroupId As  Nullable(Of Int32) ,  ByVal runDateTime As DateTime,  ByVal isValid As Boolean,  ByVal runLog As String,  ByVal id As Int64)  Implements IRunHistoryRepository.Update
            Dim command As IDbCommand = _dbRunHistoryCommandProvider.GetUpdateDbCommand(TestId, ProjectId, TestGroupId, RunDateTime, IsValid, RunLog, Id)
            command.Connection = _dbConnHolder.Connection
            _dbConnHolder.Open()
    ...
    Public Sub Update(ByVal runHistory as RunHistory)  Implements IRunHistoryRepository.Update
             With RunHistory
Update(.TestId, .ProjectId, .TestGroupId,  CDate(.RunDateTime),  CBool(.IsValid), .RunLog,  CLng(.Id))
       End With
...
Delete( CLng(.Id))
    ...
    End Sub
          Public Function Insert( ByVal testId As  Nullable(Of Int32) ,  ByVal projectId As  Nullable(Of Int32) ,  ByVal testGroupId As  Nullable(Of Int32) ,  ByVal runDateTime As DateTime,  ByVal isValid As Boolean,  ByVal runLog As String)  as Int64 Implements IRunHistoryRepository.Insert
            Dim command As IDbCommand = _dbRunHistoryCommandProvider.GetInsertDbCommand(TestId, ProjectId, TestGroupId, RunDateTime, IsValid, RunLog)
            command.Connection = _dbConnHolder.Connection
            _dbConnHolder.Open()
    ...
    Public Function Insert(ByVal runHistory as RunHistory)  as Int64 Implements IRunHistoryRepository.Insert
             With RunHistory
 Return Insert(.TestId, .ProjectId, .TestGroupId,  CDate(.RunDateTime),  CBool(.IsValid), .RunLog)
       End With
