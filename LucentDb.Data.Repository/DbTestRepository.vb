    ...
    Public Class DbTestRepository
        ...
        Public Function GetData() As ICollection(Of Test) Implements ITestRepository.GetData
            ...
            Do While (reader.Read())
                Dim tempEntity As New Test(reader.GetInt32("Id"), reader.GetInt32("TestTypeId"), reader.GetInt32("TestValueTypeId"), reader.GetInt32("ProjectId"), reader.GetNullableInt32("GroupId"), reader.GetString("Name"), reader.GetString("TestValue"), reader.GetBoolean("IsActive"))
        ...
        End Function
        Public Sub Update(ByVal testTypeId As Int32, ByVal testValueTypeId As Int32, ByVal projectId As Int32, ByVal groupId As Nullable(Of Int32), ByVal name As String, ByVal testValue As String, ByVal isActive As Boolean, ByVal id As Int32) Implements ITestRepository.Update
            Dim command As IDbCommand = _dbTestCommandProvider.GetUpdateDbCommand(TestTypeId, TestValueTypeId, ProjectId, GroupId, Name, TestValue, IsActive, Id)
            command.Connection = _dbConnHolder.Connection
            _dbConnHolder.Open()
        ...
        Public Sub Update(ByVal test As Test) Implements ITestRepository.Update
            With Test
                Update(CInt(.TestTypeId), CInt(.TestValueTypeId), CInt(.ProjectId), .GroupId, .Name, .TestValue, CBool(.IsActive), CInt(.Id))
            End With
        ...
        End Sub
        Public Function Insert(ByVal testTypeId As Int32, ByVal testValueTypeId As Int32, ByVal projectId As Int32, ByVal groupId As Nullable(Of Int32), ByVal name As String, ByVal testValue As String, ByVal isActive As Boolean) As Int32 Implements ITestRepository.Insert
            Dim command As IDbCommand = _dbTestCommandProvider.GetInsertDbCommand(TestTypeId, TestValueTypeId, ProjectId, GroupId, Name, TestValue, IsActive)
            command.Connection = _dbConnHolder.Connection
            _dbConnHolder.Open()
        ...
        Public Function Insert(ByVal test As Test) As Int32 Implements ITestRepository.Insert
            With Test
                Return Insert(CInt(.TestTypeId), CInt(.TestValueTypeId), CInt(.ProjectId), .GroupId, .Name, .TestValue, CBool(.IsActive))
            End With
        ...
        End Function
        Public Function GetDataByTestValueTypeId(ByVal testValueTypeId As Int32) As ICollection(Of Test) Implements ITestRepository.GetDataByTestValueTypeId
        ...
        End Function
        Public Function GetDataByTestValueTypeIdPageable(ByVal testValueTypeId As Int32, ByVal sortExpression As String, ByVal page As Int32, ByVal pageSize As Int32) As PagedResult(Of Test) Implements ITestRepository.GetDataByTestValueTypeIdPageable
            Dim command As IDbCommand = _dbTestCommandProvider.GetGetDataByTestValueTypeIdPageableDbCommand(TestValueTypeId, sortExpression, page, pageSize)
            command.Connection = _dbConnHolder.Connection
            _dbConnHolder.Open()
            Dim entList As New Collection(Of Test)
            Dim reader As New SafeDataReader(command.ExecuteReader(CommandBehavior.CloseConnection))
        ...
        End Function
        Public Function GetDataByTestValueTypeIdRowCount(ByVal testValueTypeId As Int32) As Int32
            Dim command As IDbCommand = _dbTestCommandProvider.GetGetDataByTestValueTypeIdRowCountDbCommand(TestValueTypeId)
            command.Connection = _dbConnHolder.Connection
            _dbConnHolder.Open()
            Dim returnValue As Int32 = Convert.ToInt32(Command.ExecuteScalar())
            _dbConnHolder.Close()
        ...
        End Function
        Public Function GetActiveDataByTestValueTypeId(ByVal testValueTypeId As Int32) As ICollection(Of Test) Implements ITestRepository.GetActiveDataByTestValueTypeId
            Dim command As IDbCommand = _dbTestCommandProvider.GetGetActiveDataByTestValueTypeIdDbCommand(TestValueTypeId)
            command.Connection = _dbConnHolder.Connection
            _dbConnHolder.Open()
            Dim entList As New Collection(Of Test)
            Dim reader As New SafeDataReader(command.ExecuteReader(CommandBehavior.CloseConnection))
        ...
        End Function
        Public Function GetActiveDataByTestValueTypeIdPageable(ByVal testValueTypeId As Int32, ByVal sortExpression As String, ByVal page As Int32, ByVal pageSize As Int32) As PagedResult(Of Test) Implements ITestRepository.GetActiveDataByTestValueTypeIdPageable
            Dim command As IDbCommand = _dbTestCommandProvider.GetGetActiveDataByTestValueTypeIdPageableDbCommand(TestValueTypeId, sortExpression, page, PageSize)
            command.Connection = _dbConnHolder.Connection
            _dbConnHolder.Open()
            Dim entList As New Collection(Of Test)
            Dim reader As New SafeDataReader(command.ExecuteReader(CommandBehavior.CloseConnection))
        ...
        End Function
        Public Function GetActiveDataByTestValueTypeIdRowCount(ByVal testValueTypeId As Int32) As Int32
            Dim command As IDbCommand = _dbTestCommandProvider.GetGetActiveDataByTestValueTypeIdRowCountDbCommand(TestValueTypeId)
            command.Connection = _dbConnHolder.Connection
            _dbConnHolder.Open()
            Dim returnValue As Int32 = Convert.ToInt32(Command.ExecuteScalar())
            _dbConnHolder.Close()
