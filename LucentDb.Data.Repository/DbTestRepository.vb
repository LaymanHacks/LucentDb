...
Namespace LucentDb.Data.Repository    
    ...
    Public Function GetData()  as ICollection(Of Test) Implements ITestRepository.GetData
        Dim command As IDbCommand = _dbTestCommandProvider.GetGetDataDbCommand()
            ...
            Do While (reader.Read())
                 Dim tempEntity As New Test( reader.GetInt32("Id"),  reader.GetInt32("ProjectId"),  reader.GetInt32("TestTypeId"),  reader.GetString("Name") ,  reader.GetBoolean("IsActive"))
  ...
  <Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)> _ 
    Public Sub Update( ByVal projectId As Int32,  ByVal testTypeId As Int32,  ByVal name As String,  ByVal isActive As Boolean,  ByVal id As Int32)  Implements ITestRepository.Update
        Dim command As IDbCommand = _dbTestCommandProvider.GetUpdateDbCommand(ProjectId, TestTypeId, Name, IsActive, Id)
            command.Connection = _dbConnHolder.Connection
            _dbConnHolder.Open()
...
Delete( CInt(.Id))
  ...
  <Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Insert, true)> _ 
    Public Function Insert( ByVal projectId As Int32,  ByVal testTypeId As Int32,  ByVal name As String,  ByVal isActive As Boolean)  as Int32 Implements ITestRepository.Insert
 ...
 Return Insert( CInt(.ProjectId),  CInt(.TestTypeId),  CStr(.Name),  CBool(.IsActive))
  ...
  <Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Select, false)> _ 
    ...
    ''' <summary>
    ''' Function GetTestsForScriptByScriptId returns a Script
    ''' </summary>
   ''' <param name="ScriptId"></param>''' <returns></returns>
   ''' <remarks></remarks> 
  <Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Select, false)> _ 
    Public Function GetTestsForScriptByScriptId( ByVal scriptId As Int32)  as ICollection(Of Test) Implements ITestRepository.GetTestsForScriptByScriptId
        Dim command As IDbCommand = _dbTestCommandProvider.GetGetTestsForScriptByScriptIdDbCommand(ScriptId)
            command.Connection = _dbConnHolder.Connection
            _dbConnHolder.Open()
              Dim entList as new Collection(Of Test)
            Dim reader As New SafeDataReader(command.ExecuteReader(CommandBehavior.CloseConnection))
