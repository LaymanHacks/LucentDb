...
{
    [Serializable]
    public partial class ExpectedResultTypeList :  Collection<ExpectedResultType>
    {
    ...
    [DataContract]
    public partial class ExpectedResultType{
      
        private Int32 _id;
        private String _name;
        private Collection<ExpectedResult> _expectedResults;  

      public ExpectedResultType() : base()
      {
      }

      public ExpectedResultType(Int32 id, String name) : base()
      {
