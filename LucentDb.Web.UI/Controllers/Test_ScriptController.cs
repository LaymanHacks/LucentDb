...
namespace LucentDb.Web.UI.Controllers
{
    public class Test_ScriptController : Controller
    {
        ...
        public ActionResult Details(int testId, int scriptId)
        {
        ...
        public ActionResult Edit(int testId, int scriptId)
        {
        ...
        [HttpPost]
        public ActionResult Edit(int testId, int scriptId, Test_Script test_Script)
        {
            try
            {
