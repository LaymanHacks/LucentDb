...
namespace LucentDb.Web.UI.Controllers
{
    public class Project_ConnectionController : Controller
    {
        ...
        public Project_ConnectionController(IProject_ConnectionRepository dbProject_ConnectionRepository, IProjectRepository dbProjectRepository, IConnectionRepository dbConnectionRepository)
        {
        ...
        public ActionResult Details(Int32 projectId, Int32 connectionId)
        {
            return View(_dbProject_ConnectionRepository.GetDataByProjectIdConnectionId(projectId, connectionId).FirstOrDefault());
        }
        ...
        public ActionResult Edit(Int32 projectId, Int32 connectionId)
        {
        	var project_Connection = _dbProject_ConnectionRepository.GetDataByProjectIdConnectionId(projectId, connectionId).FirstOrDefault();    
            if (project_Connection != null) ViewBag.Projects = new SelectList(_dbProjectRepository.GetData(), "ProjectId", "ProjectId", project_Connection.ProjectId);
            if (project_Connection != null) ViewBag.Connections = new SelectList(_dbConnectionRepository.GetData(), "ConnectionId", "ConnectionId", project_Connection.ConnectionId);
        ...
        [HttpPost]
        public ActionResult Edit(Int32 projectId, Int32 connectionId, Project_Connection project_Connection)
        {
            try
            {
                _dbProject_ConnectionRepository.Update(project_Connection);
                return RedirectToAction("Index");
            }
            catch
            {
