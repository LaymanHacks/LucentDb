...
namespace LucentDb.Web.UI.Controllers.Api
{
    public class Test_ScriptApiController : ApiController
    {
        ...
        [HttpDelete]
        public HttpResponseMessage Delete(Int32 testId, Int32 scriptId)
        {
            try
            {
        ...
        [HttpGet]
        public IQueryable<Test_Script> GetDataByTestIdScriptId(Int32 testId, Int32 scriptId) 
        {
        ...
        [HttpGet]
        public IQueryable<Test_Script> GetDataByScriptId(Int32 scriptId) 
        {
        ...
        public  HttpResponseMessage  GetDataByScriptIdPageable(Int32 scriptId, String sortExpression, Int32 page, Int32 pageSize) 
        {
            ...
            var pagedResults = PagedResultHelper.CreatePagedResult(Request, "Test_ScriptGetDataByScriptIdPageableRoute", page,
                pageSize, totalCount, results);
            return Request.CreateResponse(HttpStatusCode.OK, pagedResults);
        }
        ...
        [HttpGet]
        public IQueryable<Test_Script> GetDataByTestId(Int32 testId) 
        {
        ...
        public  HttpResponseMessage  GetDataByTestIdPageable(Int32 testId, String sortExpression, Int32 page, Int32 pageSize) 
        {
            ...
            var pagedResults = PagedResultHelper.CreatePagedResult(Request, "Test_ScriptGetDataByTestIdPageableRoute", page,
                pageSize, totalCount, results);
            return Request.CreateResponse(HttpStatusCode.OK, pagedResults);
        }
