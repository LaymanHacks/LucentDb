...
namespace LucentDb.Web.UI.Controllers.Api
{
    public class Project_ConnectionApiController : ApiController
    {
        ...
        [HttpPut]
        public void Update(Project_Connection projectConnection, int originalProjectId, int originalConnectionId)
        {
            _dbRepository.Update(projectConnection.ProjectId, projectConnection.ConnectionId, originalProjectId,
