...
namespace LucentDb.Web.UI.Controllers.Api
{
    public class Script_ExpectedResultApiController : ApiController
    {
        ...
        [HttpDelete]
        public HttpResponseMessage Delete(int scriptId, int expectedResultId)
        {
            try
            {
        ...
        [Route("api/script_ExpectedResult/all", Name = "Script_ExpectedResultGetDataByExpectedResultIdRoute")]
        [HttpGet]
        ...
        [Route("api/script_ExpectedResult", Name = "Script_ExpectedResultGetDataByExpectedResultIdPageableRoute")]
        [HttpGet]
        ...
        [Route("api/script_ExpectedResult/all", Name = "Script_ExpectedResultGetDataByScriptIdRoute")]
        [HttpGet]
        ...
        [HttpGet]
        public IQueryable<Script_ExpectedResult> GetDataByScriptIdExpectedResultId(int scriptId, int expectedResultId)
        {
            return _dbRepository.GetDataByScriptIdExpectedResultId(scriptId, expectedResultId).AsQueryable();
        }

        [Route("api/script_ExpectedResult", Name = "Script_ExpectedResultGetDataByScriptIdPageableRoute")]
        [HttpGet]
        ...
        public IQueryable<Script_ExpectedResult> Insert(Script_ExpectedResult script_ExpectedResult)
        {
            return
                _dbRepository.Insert(script_ExpectedResult.ScriptId, script_ExpectedResult.ExpectedResultId,
                    script_ExpectedResult.ResultIndex).AsQueryable();
        }

        [Route("api/script_ExpectedResult", Name = "Script_ExpectedResultUpdateRoute")]
        [HttpPut]
        public void Update(Script_ExpectedResult script_ExpectedResult, int Original_ScriptId,
            int Original_ExpectedResultId)
        {
            _dbRepository.Update(script_ExpectedResult.ScriptId, script_ExpectedResult.ExpectedResultId,
                script_ExpectedResult.ResultIndex, Original_ScriptId, Original_ExpectedResultId);
        }
    }
}