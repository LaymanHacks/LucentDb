...
namespace LucentDb.Web.UI.Controllers.Api
{
    public class ConnectionApiController : ApiController
    {
        ...
        {
            _dbRepository.Update(connection.ProjectId, connection.ConnectionProviderId, connection.Name,
                connection.ConnectionString, connection.IsDefault, connection.IsActive, connection.ConnectionId);
        }
        ...
        {
            return _dbRepository.Insert(connection.ProjectId, connection.ConnectionProviderId, connection.Name,
        ...
        [HttpGet]
        public IQueryable<Connection> GetActiveDataByProjectId(int projectId)
        {
