...
namespace LucentDb.Web.UI.Controllers.Api
{
    public class RunHistoryApiController : ApiController
    {
        ...
        {
            _dbRepository.Update(runHistory.TestId, runHistory.RunDateTime, runHistory.IsPass, runHistory.RunLog,
        ...
        {
            return _dbRepository.Insert(runHistory.TestId, runHistory.RunDateTime, runHistory.IsPass, runHistory.RunLog,
