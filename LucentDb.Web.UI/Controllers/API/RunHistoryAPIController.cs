...
namespace LucentDb.Web.UI.Controllers.Api
{
    public class RunHistoryApiController : ApiController
    {
        ...
        {
            _dbRepository.Update(runHistory.TestId, runHistory.ProjectId, runHistory.GroupId,  (DateTime)runHistory.RunDateTime,  (bool)runHistory.IsValid, runHistory.RunLog, runHistory.Id);
          }
        ...
        {
             return _dbRepository.Insert(runHistory.TestId, runHistory.ProjectId, runHistory.GroupId,  (DateTime)runHistory.RunDateTime,  (bool)runHistory.IsValid, runHistory.RunLog);
          }
