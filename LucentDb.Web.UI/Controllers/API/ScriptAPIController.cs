...
namespace LucentDb.Web.UI.Controllers.Api
{
    public class ScriptApiController : ApiController
    {
        ...
        [Route("api/scripts/all/active", Name = "ScriptsGetActiveDataByScriptTypeIdRoute")]
        [HttpGet]
        ...
        [Route("api/scripts/active", Name = "ScriptsGetActiveDataByScriptTypeIdPageableRoute")]
        [HttpGet]
        ...
        [Route("api/scripts/all", Name = "ScriptsGetDataByScriptTypeIdRoute")]
        [HttpGet]
        ...
        [Route("api/scripts", Name = "ScriptsGetDataByScriptTypeIdPageableRoute")]
        [HttpGet]
        ...
        [HttpGet]
        public IQueryable<Script> GetScriptsForTestByTestId(int testId)
        {
        ...
        {
            return _dbRepository.Insert(script.ScriptTypeId, script.Name, script.ScriptValue, script.IsActive);
        }
        ...
        {
            _dbRepository.Update(script.ScriptTypeId, script.Name, script.ScriptValue, script.IsActive, script.Id);
        }
    }
}