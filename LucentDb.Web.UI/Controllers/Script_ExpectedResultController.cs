...
namespace LucentDb.Web.UI.Controllers
{
    public class Script_ExpectedResultController : Controller
    {
        ...
        public Script_ExpectedResultController(IScript_ExpectedResultRepository dbScript_ExpectedResultRepository,
            IScriptRepository dbScriptRepository, IExpectedResultRepository dbExpectedResultRepository)
        {
        ...
        //[Route("Script_ExpectedResult/Details/", Name = "GetScript_ExpectedResultDetails")]
        //public ActionResult Details()
        //{
        //    return View(_dbScript_ExpectedResultRepository.GetDataBy().FirstOrDefault());
        //}

        //// GET: Script_ExpectedResult/Edit/5
        //[Route("Script_ExpectedResult/Edit/", Name = "GetScript_ExpectedResultEdit")]
        //public ActionResult Edit()
        //{
        //    var script_ExpectedResult = _dbScript_ExpectedResultRepository.GetDataBy().FirstOrDefault();
        //    if (script_ExpectedResult != null)
        //        ViewBag.Scripts = new SelectList(_dbScriptRepository.GetData(), "Id", "Id",
        //            script_ExpectedResult.ScriptId);
        //    if (script_ExpectedResult != null)
        //        ViewBag.ExpectedResults = new SelectList(_dbExpectedResultRepository.GetData(), "Id", "Id",
        //            script_ExpectedResult.ExpectedResultId);

        //    return View(script_ExpectedResult);
        //}

        //// POST: Script_ExpectedResult/Edit/5
        //[Route("Script_ExpectedResult/Edit/", Name = "PostScript_ExpectedResultEdit")]
        //[HttpPost]
        //public ActionResult Edit(Script_ExpectedResult script_ExpectedResult)
        //{
        //    try
        //    {
