...
namespace LucentDb.Web.UI.Controllers
{
    public class Script_ExpectedResultController : Controller
    {
        ...
        public ActionResult Details(int scriptId, int expectedResultId)
        {
            return
                View(
                    _dbScript_ExpectedResultRepository.GetDataByScriptIdExpectedResultId(scriptId, expectedResultId)
                        .FirstOrDefault());
        }
        ...
        public ActionResult Edit(int scriptId, int expectedResultId)
        {
            var script_ExpectedResult =
                _dbScript_ExpectedResultRepository.GetDataByScriptIdExpectedResultId(scriptId, expectedResultId)
                    .FirstOrDefault();
        ...
        [HttpPost]
        public ActionResult Edit(int scriptId, int expectedResultId, Script_ExpectedResult script_ExpectedResult)
        {
            try
            {
