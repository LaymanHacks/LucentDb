CodeMirror.defineMode("sass",
    function(config) {
        ...
        var tags = [
            ...
            "basefont", "bdi", "bdo", "big", "blockquote", "body", "br", "button", "canvas", "caption", "cite", "code",
            "col", "colgroup", "command", "datalist", "dd", "del", "details", "dfn", "dir", "div", "dl", "dt", "em",
            ...
            "keygen", "kbd", "label", "legend", "li", "link", "map", "mark", "menu", "meta", "meter", "nav", "noframes",
            "noscript", "object", "ol", "optgroup", "option", "output", "p", "param", "pre", "progress", "q", "rp",
        ...
        var pseudoElements = [
            ":first-line", ":hover", ":first-letter", ":active", ":visited", ":before", ":after", ":link", ":focus",
            ":first-child", ":lang"
        ];
