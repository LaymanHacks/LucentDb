    ...
    public class ConnectionApiControllerTests
    {
        ...
        public void Update_Should_Update_A_Connection() 
        {
            _repository
                 ...
                 .Callback<String, String, Boolean, Int32>((name, connectionString, isActive, id) => 
            { 
                 var tConnection = _repositoryList.Find(x => x.Id==id);
                 tConnection.Name = name; 
                 tConnection.ConnectionString = connectionString; 
                 tConnection.IsActive = isActive; 
            });
            var tempConnection = _repositoryList.Find(x => x.Id==id);
        ...
        public void GetDataPageableTest()
        {
            ...
            _repository
                 ...
                 { 
                      ...
                      {
                          case  "Id":
                              query = new List<Connection>(query.OrderBy(q => q.Id));
                              break;
                          case  "Name":
        ...
        [TestMethod()]
        public void GetConnectionsByProjectIdTest() 
        {
            _repository
                 .Setup(it => it.GetConnectionsByProjectId(It.IsAny<Int32>()))
                     .Returns<Int32>((projectId) => 
                 { 
                      return _repositoryList.Where(x => x.ProjectId==projectId).ToList();
                 });
                
            var result = _target.GetConnectionsByProjectId(projectIdValue).ToList();
