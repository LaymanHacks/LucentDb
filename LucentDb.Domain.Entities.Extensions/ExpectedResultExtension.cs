...
namespace LucentDb.Domain.Entities.Extensions
{
    public static class ExpectedResultExtensions
    {
        ...
        public static ExpectedResult IncludeExpectedResultType(this ExpectedResult expectedResult,
            IExpectedResultTypeRepository expectedResultTypeRepository)
        {
            if (expectedResult.ExpectedResultType != null) return expectedResult;
            expectedResult.ExpectedResultType =
                expectedResultTypeRepository.GetDataById((int) expectedResult.ExpectedResultTypeId).ToList().First();
            return expectedResult;
        }
