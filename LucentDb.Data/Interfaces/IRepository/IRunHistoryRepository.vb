...
Namespace LucentDb.Data.Repository
    Public Interface IRunHistoryRepository
        ...
        Sub Update(testId As Int32, runDateTime As DateTime, isPass As Boolean, runLog As String, resultString As String,
                   id As Int64)
        ...
        Function Insert(testId As Int32, runDateTime As DateTime, isPass As Boolean, runLog As String,
