...
Namespace LucentDb.Data.DbCommandProvider
    Public Interface IDbTestCommandProvider
        ...
        Function GetUpdateDbCommand( ByVal projectId As Int32,  ByVal testTypeId As Int32,  ByVal name As String,  ByVal isActive As Boolean,  ByVal id As Int32) As IDbCommand
        Function GetDeleteDbCommand( ByVal id As Int32) As IDbCommand
        Function GetInsertDbCommand( ByVal projectId As Int32,  ByVal testTypeId As Int32,  ByVal name As String,  ByVal isActive As Boolean) As IDbCommand
        ...
        Function GetGetTestsForScriptByScriptIdDbCommand( ByVal scriptId As Int32) As IDbCommand
