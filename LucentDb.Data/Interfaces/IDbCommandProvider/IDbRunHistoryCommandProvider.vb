...
Namespace LucentDb.Data.DbCommandProvider
    Public Interface IDbRunHistoryCommandProvider
        ...
        Function GetUpdateDbCommand(testId As Int32, runDateTime As DateTime, isPass As Boolean, runLog As String,
                                    resultString As String, id As Int64) As IDbCommand

        Function GetDeleteDbCommand(id As Int64) As IDbCommand

        Function GetInsertDbCommand(testId As Int32, runDateTime As DateTime, isPass As Boolean, runLog As String,
