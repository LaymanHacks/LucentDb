...
Namespace LucentDb.Data.DbCommandProvider
    Public Interface IDbRunHistoryCommandProvider
        ...
        Function GetUpdateDbCommand(id As Int64, scriptId As Int32, runDateTime As DateTime, isPass As Boolean,
                                    resultString As String, original_Id As Int64) As IDbCommand

        Function GetDeleteDbCommand(id As Int64) As IDbCommand

        Function GetInsertDbCommand(id As Int64, scriptId As Int32, runDateTime As DateTime, isPass As Boolean,
