...
Namespace LucentDb.Data.DbCommandProvider
    Public Interface IDbTestValueTypeCommandProvider
        ...
        Function GetUpdateDbCommand(testTypeId As Int32, name As String, isActive As Boolean, id As Int32) As IDbCommand
        Function GetDeleteDbCommand(id As Int32) As IDbCommand
        Function GetInsertDbCommand(testTypeId As Int32, name As String, isActive As Boolean) As IDbCommand
