...
Namespace LucentDb.Data.DbCommandProvider
    Public Interface IDbProjectCommandProvider
        ...
        Function GetGetProjectsForConnectionByConnectionIdDbCommand(connectionId As Int32) As IDbCommand

        Function GetGetProjectsForConnectionByConnectionIdPageableDbCommand(connectionId As Int32,
                                                                            sortExpression As String, page As Int32,
                                                                            pageSize As Int32) As IDbCommand

        Function GetGetProjectsForConnectionByConnectionIdRowCountDbCommand(connectionId As Int32) As IDbCommand
    End Interface
End Namespace
