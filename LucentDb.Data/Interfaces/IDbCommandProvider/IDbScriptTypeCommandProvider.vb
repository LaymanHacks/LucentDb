...
Namespace LucentDb.Data.DbCommandProvider
    Public Interface IDbScriptTypeCommandProvider
        ReadOnly Property ScriptTypeDbConnectionHolder() As DbConnectionHolder
        ReadOnly Property DbConnectionName As String
        Function GetGetDataDbCommand() As IDbCommand
        Function GetUpdateDbCommand( ByVal name As String,  ByVal isActive As Boolean,  ByVal id As Int32) As IDbCommand
