  ...
  public class DataRepository
    {
         ...
         public DataRepository()
         {
             ...
             ProjectConnectionRepository = new DbProject_ConnectionRepository( new SqlDbProject_ConnectionCommandProvider());
      ...
      public ITestTypeRepository DbTestTypeRepository { get; set; }
